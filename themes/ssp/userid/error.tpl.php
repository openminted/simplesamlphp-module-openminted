...
<div class="row">
  <div class="col-sm-12">
  <?php
    $friendly_title = '<h2>' . $this->t('{themeopenminted:userid_error:friendly_title}') . '</h2>';
    echo $friendly_title;
  ?>
    <p><?php echo $this->t('{themeopenminted:userid_error:friendly_description}', $this->data['parameters']); ?></p>
    <p><?php echo $this->t('{themeopenminted:userid_error:resolution_description}', array('%RETRY_URL%' => $retryUrl)); ?></p>
  </div>
</div>
<div class="row">
  <div class="col-sm-12">
